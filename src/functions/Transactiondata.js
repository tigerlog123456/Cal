                ...
                <table className="min-w-full rounded-lg overflow-hidden">
                    <thead className="bg-gray-100 dark:bg-gray-700">
                        <tr className="text-gray-800 dark:text-white">
                            ...
                            <th className="p-3 text-left">Confirmed At</th>
                    ...
                    <tbody className="bg-white dark:bg-gray-800 divide-y divide-gray-200 dark:divide-gray-700">
                        {filteredTransactions.map((transaction) => (
                            <tr key={transaction.id} className="hover:bg-gray-100 dark:hover:bg-gray-700 transition-all">
                                ...
                                <td className="p-3">{transaction.userFullname}</td>
                                <td className="p-3">{transaction.marketName}</td>
                                <td className="p-3">${transaction.marketPrice}</td>
                                <td className="p-3">{transaction.quantity}</td>
                                <td className="p-3 font-semibold">${transaction.marketPrice * transaction.quantity}</td>
                                <td className="p-3 text-gray-500 dark:text-gray-400 text-sm">{formatDate(transaction.createdAt)}</td>
                                <td className="p-3">
                                    <button
                                        onClick={() => generateTransactionPDF(transaction)}
